...
proc generate {} {
   ...
   message DEBUG "Generation of the SelectIO Wizard"
   message DEBUG "__________________________________________________________________"
...
## Added as per Alex Shaw's email
...
set GenerationOptions(InstantiationTemplates) {
   com.xilinx.ip.selectio_wiz_v3_2.template_v
   com.xilinx.ip.selectio_wiz_v3_2.template_vhd
}
