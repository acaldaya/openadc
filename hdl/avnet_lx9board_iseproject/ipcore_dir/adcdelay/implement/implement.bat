...
xst -ifn xst.scr
move adcdelay_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\..\adcdelay.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adcdelay.ucf adcdelay_exdes

echo 'Running map'
map -timing adcdelay_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm adcdelay_exdes -w routed.ncd routed.v
cd ..
