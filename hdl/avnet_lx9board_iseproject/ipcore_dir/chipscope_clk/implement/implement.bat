...
xst -ifn xst.scr
move chipscope_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\chipscope_clk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc chipscope_clk.ucf chipscope_clk_exdes

echo 'Running map'
map -timing -pr b chipscope_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm chipscope_clk_exdes -w routed.ncd routed.v
cd ..
