...
xst -ifn xst.scr
move adc_internaldelaygen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\adc_internaldelaygen.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adc_internaldelaygen.ucf adc_internaldelaygen_exdes

echo 'Running map'
map -timing -pr b adc_internaldelaygen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm adc_internaldelaygen_exdes -w routed.ncd routed.v
cd ..
